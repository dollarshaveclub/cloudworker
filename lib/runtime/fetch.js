...
async function fetchShim (...args) {
  ...
  if (args[1] && args[1]['cf']) {
    resolveOverride = args[1]['cf']['resolveOverride'] || ""
  }
  ...
  if (resolveOverride === "") {
    ...
    // This specific step is to circumvent cloudflare in our local dev env
    resolveOverride = resolveOverride.replace("invisionbeta.com", "invisionapp-origin.com");
    resolveOverride = resolveOverride.replace("invisionapp.com", "invisionapp-origin.com");
    req = new Request(dest.protocol + '//' + resolveOverride + dest.pathname, req)
  }
